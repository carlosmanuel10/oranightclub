...
/*!Floating menu*/
	/*if (smartMenu) {*/
		var scrTop = 0,
            ...
            $phantomhome = $("#phantomhome"),
			$menuBox = $phantom.find(".menu-box"),
            $menuBoxhome = $phantomhome.find(".menu-box"),
            ...
            threshold = 200,
            thresholdhome = $(window).height()+300,
			doScroll = false;
        
        $phantomhome.addClass("test");
        
		if(!$(".vc-editor").length > 0){
			if ($("#wpadminbar").exists()) { $phantom.css("top", "28px"); $phantomhome.css("top", "28px"); };
		}
		if ($("#page").hasClass("boxed")) { $phantom.find(".ph-wrap").addClass("boxed"); $phantom.addClass("boxed"); $phantomhome.find(".ph-wrap").addClass("boxed"); $phantomhome.addClass("boxed");}

		if (dtGlobals.logoURL && dtGlobals.logoEnabled) {
			$phantom.find(".ph-wrap").addClass("with-logo");
            $phantomhome.find(".ph-wrap").addClass("with-logo");
			if(logoURL == undefined){
				$phantom.find(".logo-box").html('<img src="'+dtGlobals.logoURL+'" height="'+dtGlobals.logoH+'" width="'+dtGlobals.logoW+'">');
                $phantomhome.find(".logo-box").html('<img src="'+dtGlobals.logoURL+'" height="'+dtGlobals.logoH+'" width="'+dtGlobals.logoW+'">');
			}else{
				$phantom.find(".logo-box").html('<a href="'+logoURL+'"><img src="'+dtGlobals.logoURL+'" height="'+dtGlobals.logoH+'" width="'+dtGlobals.logoW+'"></a>');
                $phantomhome.find(".logo-box").html('<a href="'+logoURL+'"><img src="'+dtGlobals.logoURL+'" height="'+dtGlobals.logoH+'" width="'+dtGlobals.logoW+'"></a>');
			}
		}
		$(".one-page-row .logo-box a").on('click',function(e){
            ...
            if($("#phantomhome").css("display")=="block"){
				var floatMenuH = $("#phantomhome").height();
			}else{
				var floatMenuH = 0;
			}
			var $_this = $(this),
		...
		$(window).on("scroll", function() {
            ...
            if ($phantomhome.exists()) {
                
                if (tempScrTop > thresholdhome && isMoved === false) {
                    if( !dtGlobals.isHovering ) {
                        $phantomhome.css({"opacity": 1, "visibility": "visible"});
                        $header.appendTo($menuBoxhome);
                        isMoved = true;
                    }
                } else if (tempScrTop <= thresholdhome && isMoved === true) {
                    ...
                    $phantomhome.css({"opacity": 0, "visibility": "hidden"});
                    isMoved = false;
                };
